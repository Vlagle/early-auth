...
IDOfChannelToSendTicketCreationEmbed = 1235265554928107540              #ID of the Channel to send the Create a ticket embed to
IDofMessageForTicketCreation = 1235300641006419988                       #This variable was automatically adjusted.
activeTicketsCategoryID = 1178285959419265064                     #ID of the active tickets category
...
OptionsDict = {
    ...
    "Option 4": ("Друг / Friend", "friend", "Для тех, кто хочет быть другом полка. For those who want to be a friend of the regiment.") 
